...
st.markdown("<p style='text-align: center; font-size: 18px;'>A professional web app to classify Iris flowers using Machine Learning.</p>", unsafe_allow_html=True)
...
report_df["Predicted Species"] = iris_species[prediction]
csv = report_df.to_csv(index=False)
st.download_button(
    label="📄 Download Report as CSV",
    data=csv,
    file_name="iris_prediction_report.csv",
    mime="text/csv"
)
